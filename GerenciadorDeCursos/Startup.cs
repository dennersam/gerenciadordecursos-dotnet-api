...
namespace GerenciadorDeCursos
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            var configurationSection = Configuration.GetSection("JWTConfig");
            var configurationJWT = configurationSection.Get<JWTConfig>();
            ...
            services.AddAuthentication(options =>
            {
                ...
                .AddJwtBearer(options =>
                {
                    ...
                    {
                        IssuerSigningKey = new SymmetricSecurityKey(Encoding.ASCII.GetBytes(configurationJWT.Secret)),
